...
-   Scenarios represent realistic workflows/use case scenarios
...
T3                      Exception Case          A deviation from the normal flow where the system must handle unexpected situations.

T4                      Negative Case           Invalid input or state that must be rejected by the system.

T5                      Misuse Case             Deliberate misuse or manipulation attempts to test system robustness.
...
T5_login_SQLInjection_userGetErrormessageAndIsNotLoggedIN
